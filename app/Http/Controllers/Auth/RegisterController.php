    ...
    */
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'attestatnumber' => 'required|integer|min:3',
            'attestattype' => 'required|string|min:3|max:255',
            'payment' => 'required|string|min:3|max:255',
            'certificatenumber' => 'required|integer|min:3',
    ...
    protected function create(array $data)
    {
        return User::create([
            ...
            'school' => $data['school'],
            'score' => $data['score'],
            'attestatnumber' => $data['attestatnumber'],
            'attestatdate' => $data['attestatdate'],
            'attestattype' => $data['attestattype'],
